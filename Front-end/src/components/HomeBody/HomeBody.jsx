    ...
    <div className="container-fluid home-body">
      <div className="row row-1">
        ...
        <div className="col-12 col-md-12 col-lg-6 text-side">
          <h1>Hello there,</h1>
          <h3>Welcome to Yalla Tour, your ultimate guide to exploring
              the captivating beauty and rich history of Iraq! We are
              thrilled to introduce ourselves and share our passion
              for connecting travelers with the wonders that this
